    ...
    public class GenerateRecoveryCodesModel : PageModel
    {
        ...
        public async Task<IActionResult> OnGetAsync()
        {
            ...
            if (!isTwoFactorEnabled)
            {
                ...
                throw new InvalidOperationException($"Kimliği olan kullanıcı için kurtarma kodları oluşturulamıyor '{userId}' çünkü 2FA etkin değil.");
            }
        ...
        public async Task<IActionResult> OnPostAsync()
        {
            ...
            if (!isTwoFactorEnabled)
            {
                throw new InvalidOperationException($"Kimliği olan kullanıcı için kurtarma kodları oluşturulamıyor '{userId}' 2FA etkin olmadığı için.");
            }
